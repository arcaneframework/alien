    ...
    public:
        ...
        static std::string solverEnumToString(OptionTypes::eSolver solver) {
            switch (solver) {
                ...
                case OptionTypes::BiCGstab:
                    return "bcgs";
                default:
                    throw Arccore::FatalErrorException(A_FUNCINFO, Arccore::String::format(
                            "Unmanaged PetscOptionTypes::eSolver value: {0}", solver));
            }
        }
        ...
        static std::string preconditionerEnumToString(OptionTypes::ePreconditioner preconditioner) {
            switch (preconditioner) {
                ...
                default:
                    throw Arccore::FatalErrorException(A_FUNCINFO, Arccore::String::format(
                            "Unmanaged PetscOptionTypes::ePreconditioner value: {0}", preconditioner));
            }
        }
    };*/
